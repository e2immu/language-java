...
public class TestParseGenerics extends CommonJmodBaseTests {
    ...
    public void testExtends2() throws URISyntaxException {
        ...
        ParseGenerics parseGenerics = new ParseGenerics(runtime, newTypeContext, typeInfo,
    ...
    public void testGenericsAbstractClassLoaderValue() throws URISyntaxException {
        ...
        newTypeContext.addToContext(new TypeParameterImpl(0, "V", Either.left(typeInfo)).builder().commit());
        newTypeContext.addToContext(new TypeParameterImpl(1, "CLV", Either.left(typeInfo)).builder().commit());

        ByteCodeInspectorImpl byteCodeInspector = new ByteCodeInspectorImpl(runtime, classPath, null, newTypeContext);
        typeContext.typeMap().add(typeInfo, STARTING_BYTECODE);
